      ...
      <article className='About-item'>
        ...
        <main className='About-main'>
          ...
          <div className='About-button'>
            <Button aria-label='Abrir link' href='https://gringolandiaenglis.wixsite.com/freeclass' target='no_blank' $secondary>GRUPO VIP DE TELEGRAM</Button>
          </div>
        </main>
      </article>
      <Button className='About-button-mobile' href='https://gringolandiaenglis.wixsite.com/freeclass' target='no_blank' $secondary>GRUPO VIP DE TELEGRAM</Button>
    </section>
  )
}
